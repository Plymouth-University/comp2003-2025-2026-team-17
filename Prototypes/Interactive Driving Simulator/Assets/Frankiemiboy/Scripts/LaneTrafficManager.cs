...
public class LaneTrafficManager : MonoBehaviour
{
    ...
    private void SpawnAndSetupNewCar()
    {
        ...
        InitialWaypointFollower tempBrain = carPrefab.GetComponent<InitialWaypointFollower>();
        if (tempBrain != null)
        {
        ...
        InitialWaypointFollower aiBrain = spawnedCar.GetComponent<InitialWaypointFollower>();
    ...
    private void ReleaseCarFromBuffer()
    {
        ...
        InitialWaypointFollower aiBrain = car.GetComponent<InitialWaypointFollower>();
        if (aiBrain != null)
        {

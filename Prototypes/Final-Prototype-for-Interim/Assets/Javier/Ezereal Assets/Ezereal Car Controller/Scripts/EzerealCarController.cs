...
namespace Ezereal
{
    public class EzerealCarController : MonoBehaviour // This is the main system resposible for car control.
    {
        ...
        // AI radio obsolete [SerializeField] RealAIRadio realAIRadio; // UPDATE: Added reference to the AI Radio script so that we can call it from here when the player presses the button to turn on the radio.
